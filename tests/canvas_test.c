...
START_TEST(test_canvas_get_bottom_right_corner) {
    ...
    fail_unless(point_are_equals(canvas_get_bottom_right_corner(&canvas), corner), "should be equals (1)");
    ...
    fail_unless(point_are_equals(canvas_get_bottom_right_corner(&canvas), corner), "should be equals (2)");
}
END_TEST

START_TEST(test_canvas_get_top_left_corner) {
    ...
    fail_unless(point_are_equals(canvas_get_top_left_corner(&canvas), corner), "should be equals (1)");
    ...
    fail_unless(point_are_equals(canvas_get_top_left_corner(&canvas), corner), "should be equals (2)");
}
END_TEST

START_TEST(test_canvas_get_top_right_corner) {
    ...
    fail_unless(point_are_equals(canvas_get_top_right_corner(&canvas), corner), "should be equals (1)");
    ...
    fail_unless(point_are_equals(canvas_get_top_right_corner(&canvas), corner), "should be equals (2)");
}
END_TEST
